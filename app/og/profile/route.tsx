...
export async function GET(request: Request) {
  ...
  const fontRes = await fetch("https://fonts.gstatic.com/s/inter/v18/UcCO3FwrK3iLTeHuS_nVMrMxCp50SjIw2boKoduKmMEVuFuYAZJhjQ.woff2");
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "row", alignItems: "center", gap: 20 }}>
          ...
          <span style={{ color: "white", fontSize: 64, fontWeight: 800, fontFamily: "Inter", letterSpacing: -2 }}>linkup</span>
        </div>
      </div>
    ),
    {
